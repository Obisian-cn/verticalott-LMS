    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <div className="glass rounded-[2rem] p-8 sm:p-10 relative overflow-hidden shadow-xl shadow-indigo-900/5 border-t border-l border-white">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link to="/courses" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-bold rounded-xl text-white bg-gradient-to-r from-[#b57bff] to-[#e79a6d] hover:opacity-90 shadow-lg shadow-[#b57bff]/30 transition-all duration-300 hover:-translate-y-1 group">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          ...
          { label: 'Total Enrolled', value: enrollments.length || 0, icon: BookOpen, color: 'text-[#b57bff]', bg: 'bg-[#b57bff]/10', gradient: 'from-[#b57bff]/20 to-blue-500/5' },
        ].map((stat, i) => (
            ...
            {enrollments.map((enrollment: any) => (
              <div key={enrollment.id} className="glass rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group flex flex-col">
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <h3 className="font-bold text-lg text-white line-clamp-2 leading-tight mb-2 group-hover:text-[#b57bff] transition-colors">
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="w-full bg-white/5 rounded-full h-2.5 mb-4 shadow-inner overflow-hidden">
                      <div
                        className="bg-gradient-to-r from-[#b57bff] to-[#e79a6d] h-2.5 rounded-full transition-all duration-1000 ease-out"
                        style={{ width: `${enrollment.progress || 0}%` }}
                      ></div>
                    </div>
                    <button
                      onClick={() => navigate('/learn/' + enrollment.course?.id)}
                      className="w-full flex items-center justify-center px-4 py-2 border border-white/10 rounded-xl text-sm font-bold text-slate-300 bg-[#151518] hover:bg-white/5 hover:border-white/20 hover:text-white transition-all shadow-sm group/btn"
                    >
