...
export default function AddLectureModal({ sectionId, onClose, onSave, isLoading }: any) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-xl overflow-hidden animate-in slide-in-from-bottom-4 flex flex-col max-h-[90vh]">
        <div className="flex items-center justify-between p-5 border-b border-slate-100 bg-slate-50 shrink-0">
          <h2 className="font-bold text-lg text-slate-800">Add New Lecture (Video)</h2>
        ...
        <div className="p-6 space-y-5 overflow-y-auto">
          <div>
            <label className="block text-sm font-bold text-slate-700 mb-2">Lecture Title *</label>
            <input 
              type="text"
              autoFocus
          ...
          <div>
            ...
            <textarea 
              className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 min-h-[100px] resize-none"
          ...
          <div>
            <label className="block text-sm font-bold text-slate-700 mb-2">Upload Video *</label>
